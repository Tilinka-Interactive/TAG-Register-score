      ...
      <div className="bg-[#00a9df] relative w-full min-h-screen overflow-y-auto flex items-center justify-center p-2 md:p-6">
        ...
        <div className="relative w-full max-w-md min-h-full flex items-center justify-center z-10 py-8">
          ...
          >
                ...
                <div className="mb-6 md:mb-8 w-full flex items-center justify-center">
                  ...
                  <div className="w-[141px] h-[141px] md:w-[131px] md:h-[131px] lg:w-[133px] lg:h-[133px] rounded-full flex items-center justify-center relative flex-shrink-0">
                    ...
                    {!avatarPath && !user?.photoURL && (
                      <div className="relative z-20 w-[47.62%] h-[47.62%] bg-gradient-to-br from-white/30 to-white/10 flex items-center justify-center rounded-full">
                        <svg
                          className="w-[11.43px] h-[11.43px] md:w-[14.29px] md:h-[14.29px] lg:w-[17.14px] lg:h-[17.14px] text-white/50"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
            ...
            <div className="mb-4 md:mb-6 w-full max-w-[24rem] md:max-w-[28rem]">
              <div className="bg-white rounded-[47.647px] px-2.5 md:px-3 py-2 md:py-2.5 shadow-lg">
                <p className="font-['Helvetica',sans-serif] font-bold text-[10px] md:text-[11px] text-[#001175] text-center whitespace-nowrap">
